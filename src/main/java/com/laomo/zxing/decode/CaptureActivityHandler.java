  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      ...
      case R.id.decode_succeeded:
        Log.d(TAG, "Got zxing.decode succeeded message");
        state = State.SUCCESS;
      ...
      case R.id.decode_failed:
        // We're decoding as fast as possible, so when one zxing.decode fails, start another.
        state = State.PREVIEW;
        cameraManager.requestPreviewFrame(decodeThread.getHandler(), R.id.decode);
        break;
      case R.id.return_scan_result:
        Log.d(TAG, "Got return scan zxing.result message");
