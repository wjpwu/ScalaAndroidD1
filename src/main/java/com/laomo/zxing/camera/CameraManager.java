...
package com.laomo.zxing.camera;
...
public final class CameraManager {
    ...
    /**
     * Opens the zxing.camera driver and initializes the hardware parameters.
     * @param holder The surface object which the zxing.camera will draw preview frames into.
     * @throws java.io.IOException Indicates the zxing.camera driver failed to open.
     */
	...
	reverseImage = prefs.getBoolean(Contant.KEY_REVERSE_IMAGE, false);
    }

    /**
     * Closes the zxing.camera driver if still in use.
     */
    public void closeDriver() {
	if (camera != null) {
	    camera.release();
	    camera = null;
	    // Make sure to clear these each time we close the zxing.camera, so that any scanning rect
    ...
    /**
     * Asks the zxing.camera hardware to begin drawing preview frames to the screen.
     */
    ...
    /**
     * Tells the zxing.camera to stop drawing preview frames.
     */
    ...
    /**
     * Asks the zxing.camera hardware to perform an autofocus.
