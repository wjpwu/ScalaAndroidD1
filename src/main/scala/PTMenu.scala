...
//        App.document.selectSingleNode("//item/item[@id='"+ id + "']");     //TODO, null here
  ...
  def qrCodeView(c: Activity with FindView)(e : Element) = {
...
//              }
  ...
  def webView(c:Activity)
    ...
    var url = PTMenu.noteValue(e,"msg")
...
//      top.setVisibility(View.GONE)
    ...
    web.setWebViewClient(new WebViewClient()
    {
      override def shouldOverrideUrlLoading(view: WebView, url: String): Boolean = {
        ...
        {
          val upId = PTMenu.noteValue(e,"upid")
          val ee = PTMenu.menuWithId(upId).asInstanceOf[Element]
          goBack(ee)
          flag = true;
        }
        return flag;
...
//  abstract class HttpAsyncGet(url:String)(start: Any)(success: Array[Byte] => Any)
//    extends AsyncTask[String,Void,Array[Byte]] {
//
//    def doInBackground1(p1: Array[String]): Array[Byte] = {
//      HttpHelper.shareHttp().httpGetWithParam(HttpUtil.BASE_URL + url,"")
//    }
//
...
//    }
//
//    override def onPostExecute(result: Array[Byte]) {
...
//  }
  ...
  def ptGet(url: String)(success: String => Any){
    commonGet(url)(success)(null)(null)
  }

  def iimageGetAndRetry(retry: Int)(url: String)(start: Any)(success: Array[Byte] => Any) (fail: String => Any) (finish: String => Any)
  {
      new Thread{
        override def run() {
        }
  ...
  {
    commonGetAndRetry(3)(url)(success)(fail)(finish)
  }
...
object PTPost{
  ...
  def ptPost(cc: Activity)(url: String)(map: Map[String,String])(success: Element => Any){
    val form = new RequestParams
    for(k <- map.keys){
      form.put(k,map.get(k).get)
    }
    commonPostAndRetry(3)(url)(form)(null)(success)(null)(null)
  }

  def ptPostWithProcess(cc: Activity)(url: String)(map: Map[String,String])(success: Element => Any){
    ...
    commonPostAndRetry(3)(url)(form)(start)(success)(fail)(finish)
  }

  def commonPostAndRetry(retry: Int)(url: String)(form: RequestParams)(start: => Any)(success: Element => Any) (fail: String => Any) (finish: String => Any)
  {
    HttpUtil.post(url,form,new AsyncHttpResponseHandler()
    {
      ...
      override def onSuccess(p1: String) {
        val response = DocumentHelper.parseText(p1).getRootElement
        isOnSuccess = true
        if(success != null)
          success(response)
      }
